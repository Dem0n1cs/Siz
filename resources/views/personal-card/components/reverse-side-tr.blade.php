    ...
    <tr>
        ...
        <td data-id="reverse_side_gives_ppe_id">
            <div class="input-group">
                <select
                    class="form-select @error('reverse_side_gives.'.$key.'.ppe_id') is-invalid @enderror"
        ...
        <td data-id="reverse_side_gives_date">
            <div class="form-group">
                <input type="date"
                       class="form-control @error('reverse_side_gives.'.$key.'.date') is-invalid @enderror"
        ...
        <td data-id="reverse_side_gives_quantity">
            <div class="form-group">
                <input type="text"
                       class="form-control @error('reverse_side_gives.'.$key.'.quantity') is-invalid @enderror"
        ...
        <td data-id="reverse_side_gives_percentage_wear">
            <div class="form-group">
                <input type="text"
                       class="form-control @error('reverse_side_gives.'.$key.'.percentage_wear') is-invalid @enderror"
        ...
        <td data-id="reverse_side_gives_percentage_cost">
            <div class="form-group">
                <input type="text"
                       class="form-control @error('reverse_side_gives.'.$key.'.cost') is-invalid @enderror"
        ...
        <td data-id="reverse_side_gives_signature">
            <div class="form-group">
                ...
                <label class="custom-file-label"
                       for="reverse_side_gives[{{$key}}][signature]">
                </label>
            </div>
        </td>
        ...
        <td data-id="reverse_side_returns_date">
            <div class="form-group">
                <input type="date"
                       class="form-control @error('reverse_side_returns.'.$key.'.date') is-invalid @enderror"
        ...
        <td data-id="reverse_side_returns_quantity">
            <div class="form-group ">
                <input type="text"
                       class="form-control @error('reverse_side_returns.'.$key.'.quantity') is-invalid @enderror"
        ...
        <td data-id="reverse_side_returns_percentage_wear">
            <div class="form-group">
                <input type="text"
                       class="form-control @error('reverse_side_returns.'.$key.'.percentage_wear') is-invalid @enderror"
        ...
        <td data-id="reverse_side_returns_cost">
            <div class="form-group">
                <input type="text"
                       class="form-control @error('reverse_side_returns.'.$key.'.cost') is-invalid @enderror"
        ...
        <td data-id="reverse_side_returns_signatures" colspan="2">
            <div class="form-group">
                ...
                <input type="file"
                       ...
                       style="display: none;"/><br>
                <label class="custom-file-label"
                       for="reverse_side_returns[{{$key}}][signatures]">
                </label>
            </div>
        </td>
    </tr>
